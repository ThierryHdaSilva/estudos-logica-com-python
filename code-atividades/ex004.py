# As notas são inteiras entre 0 e 100; os dois últimos bimestres têm peso 3.
...
calc_media_ponderada = (
    nota1 * peso_bimestal1
    + nota2 * peso_bimestal1
    + nota3 * peso_bimestral2
    + nota4 * peso_bimestral2
) / (peso_bimestal1 * 2 + peso_bimestral2 * 2)

media_ponderada_inteira = round(calc_media_ponderada)

# A classificação usa a média arredondada para apresentar um resultado inteiro.
